...
namespace Workflow
{
    public static class DatabaseHelper
    {
        ...
        public static DataRow PlanetInfo(string code)
        {
            Dictionary<string, string> dict = new Dictionary<string, string>();
            dict.Add("codePlanet", code);
        ...
        public static DataRow DeliveryInfo(string deliveryCode, string planetId, string spaceShipId)
        {
            Dictionary<string, string> dict = new Dictionary<string, string>();
